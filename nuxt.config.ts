    ...
    head: {
      ...
      meta: [
        ...
        { name: "referrer", content: "strict-origin-when-cross-origin" },
        {
          ...
          content: [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://donorbox.org https://js.stripe.com https://jspm.dev https://cdn.jsdelivr.net",
            "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://rsms.me",
            "font-src 'self' https://fonts.gstatic.com https://rsms.me",
            "img-src 'self' data: https://donorbox.org https://*.stripe.com",
            "frame-src https://donorbox.org https://js.stripe.com https://hooks.stripe.com",
            "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://region1.google-analytics.com https://www.googletagmanager.com https://assets.mailerlite.com https://donorbox.org https://api.stripe.com https://q.stripe.com",
            "object-src 'none'",
            "base-uri 'self'",
          ].join("; "),
        },
