      ...
      meta: [
        ...
        { name: "referrer", content: "strict-origin-when-cross-origin" },
        {
          ...
          content: [
            ...
            "img-src 'self' data: https://donorbox.org",
            "frame-src https://donorbox.org",
            "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://www.googletagmanager.com https://assets.mailerlite.com https://donorbox.org",
            "object-src 'none'",
            "base-uri 'self'",
          ].join("; "),
        },
